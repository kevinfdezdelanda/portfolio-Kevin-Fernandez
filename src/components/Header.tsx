...
const Header: React.FC = () => {
  ...
  return (
    <header className="container mx-auto p-3 pt-2 z-10 absolute top-0 left-1/2 transform -translate-x-1/2">
      <nav className="grid grid-flow-col grid-cols-14 relative bg-gray-900 my-3 border rounded-full p-5 py-2 text-white font-light ">
        ...
        <div className="flex items-center justify-center col-span-2">
          <span className="bg-orange-400 rounded-bl-3xl rounded-tr-3xl px-5 *: py-2 font-bold text-xl transition-all duration-300 ease-in-out group ">
